...
MANIFEST = ROOT / "research" / "tw" / "p2_manifest.json"
...
def test_p2_has_exactly_one_active_slice_until_complete():
    manifest = _load()
    active = [
        item["id"]
...
def test_p2_active_or_complete_dependencies_are_complete():
    manifest = _load()
