...
const SOURCE_CATALOG=Object.freeze([
  ...
  source({id:'twse-openapi',provider:'TWSE OpenAPI',status:SOURCE_STATUS.ADOPTED,markets:['TW'],capabilities:['EQUITY_REFERENCE','INSTITUTIONAL_FLOW','CORPORATE_OPEN_DATA'],latencyClass:'DATASET_DEFINED'}),
