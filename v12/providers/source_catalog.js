...
const SOURCE_CATALOG=Object.freeze([
  ...
  source({id:'finra-research',provider:'FINRA Developer APIs / OTC Transparency',status:SOURCE_STATUS.KEY_REQUIRED,markets:['US'],capabilities:['SHORT_VOLUME','SHORT_INTEREST','OTC_ACTIVITY'],accessClass:'PUBLIC_CREDENTIAL',secretRequired:true,serverOnly:true,liveEligible:false,latencyClass:'DELAYED',evidenceRole:'CONFIRMATION'}),
  ...
  source({id:'tpex-openapi',provider:'TPEx OpenAPI',status:SOURCE_STATUS.ADOPTED,markets:['TW'],capabilities:['EQUITY_REFERENCE','MARGIN_SHORT','INSTITUTIONAL_FLOW','MONTHLY_REVENUE'],latencyClass:'DATASET_DEFINED'}),
